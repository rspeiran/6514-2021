 ...
 *
 */
public class FuelReleaseRetract extends CommandBase {
    ...
    public FuelReleaseRetract(FuelDeliverySubSystem subsystem) {
    ...
    @Override
    public void execute() {
        m_fuelDeliverySubSystem.fuelReleaseSolenoidRetract();;
