...
public class RobotContainer {
    ...
    */
    private RobotContainer() {
        ...
        SmartDashboard.putData("ShooterOn1", new ShooterOn(m_fuelShooterPIDSubsystem, 350));
        SmartDashboard.putData("ShooterOn2", new ShooterOn(m_fuelShooterPIDSubsystem, 350));
        SmartDashboard.putData("ShooterOn3", new ShooterOn(m_fuelShooterPIDSubsystem, 370));
        SmartDashboard.putData("ShooterOn4", new ShooterOn(m_fuelShooterPIDSubsystem, 360));
        ...
        m_chooser.addOption("Auto - GalacticSearchChallenge A", new AutoGalacticSearchChallengePathA());
        m_chooser.addOption("Auto - GalacticSearchChallenge B", new AutoGalacticSearchChallengePathB());
        m_chooser.addOption("Auto - Boune Path", new AutoBouncePath());
        m_chooser.addOption("Auto - Salaom Path ", new AutoSlalomPath());
        m_chooser.addOption("Auto - Ramsete Testing ", new AutoSlalomPath());

        // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS

        SmartDashboard.putData("Auto Mode", m_chooser);

        m_chooserShooingPoint.setDefaultOption("REINTROZONE", new ShooterOff(m_fuelShooterPIDSubsystem));
        m_chooserShooingPoint.addOption("GREEN ZONE", new ShooterOn(m_fuelShooterPIDSubsystem, 350));
        m_chooserShooingPoint.addOption("YELLOW ZONE", new ShooterOn(m_fuelShooterPIDSubsystem, 350));
        m_chooserShooingPoint.addOption("BLUE ZONE", new ShooterOn(m_fuelShooterPIDSubsystem, 350));
        m_chooserShooingPoint.addOption("RED ZONE", new ShooterOn(m_fuelShooterPIDSubsystem, 350));
        m_chooserShooingPoint.addOption("SHOOTING ZONE", new ShooterOn(m_fuelShooterPIDSubsystem, 350));
