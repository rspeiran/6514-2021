...
public class RobotContainer {
    ...
    */
    private RobotContainer() {
        ...
        m_chooser.setDefaultOption("Auto - BarrelRacing Path", new AutoBarrelRacingPath());
        m_chooser.setDefaultOption("Auto - GalacticSearchChallengeA", new AutoGalacticSearchChallengePathA());
        m_chooser.setDefaultOption("Auto - GalacticSearchChallengeB", new AutoGalacticSearchChallengePathB());
        m_chooser.setDefaultOption("Auto - Boune Path", new AutoBouncePath());
        m_chooser.setDefaultOption("Auto - SalaomPath ", new AutoSlalomPath());
