...
public class LiftSubsystem extends SubsystemBase {
    ...
    //private PWMVictorSPX liftWinchSpeedController;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS

    private Spark liftSpeedController;
    ...
    */
    public LiftSubsystem() {
        ...
        //liftSpeedController = new PWMVictorSPX(6);
        //addChild("LiftSpeedController",liftSpeedController);
        //liftSpeedController.setInverted(false);

        //liftWinchSpeedController = new PWMVictorSPX(7);
        ...
        liftSpeedController = new Spark(8);
        //addChild("LiftMotors",liftMotors);
        liftSpeedController.setInverted(false);
        
        liftWinchSpeedController = new Spark(9);
        //addChild("ElevatorMotors",elevatorMotors);
        liftWinchSpeedController.setInverted(false);
        
        ElevatorRelay = new Relay(2);
    ...
    public void LiftMotorsUp() {
      ...
      public void LiftMotorsDown() {
        liftSpeedController.set(-1 * LiftSpeed);
      }
    
      public void LiftMotorsStop() {
        liftSpeedController.set(LiftStopSpeed);
      }
